...
class NestedShape extends RectangleShape {
    ...
    public NestedShape(ArrayList<Shape> list, Color fill, Color border) { 
        super(0,0,Shape.DEFAULT_MARGIN_WIDTH, Shape.DEFAULT_MARGIN_HEIGHT, Shape.DEFAULT_MARGIN_WIDTH, Shape.DEFAULT_MARGIN_HEIGHT, fill, border, PathType.BOUNCE, Shape.DEFAULT_TEXT);
        for (Shape sh: list) { 
            sh.setParent(this); 
        }
        nestedShapes = list;
